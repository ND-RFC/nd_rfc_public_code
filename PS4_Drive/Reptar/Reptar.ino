...
#define PWM1_MIN 1025 // (the leftmost)
#define PWM1_MID 1373
//#define PWM1_MID 1500
#define PWM1_MAX 1879 // (the rightmost)

// Limits for extension servo (in degrees)
#define EXTEND_MIN 114 // (higher value)
#define EXTEND_COLLISION 80 // where the drop arm would hit the cage
#define EXTEND_MAX 39   // (lower value)
