...
public:
        ...
        /* getReportCounter and resetInputBuffer have been added to extend the functionality
         * of the USB host library to allow for connection monitoring.
         */

        // Return the report counter
        int getReportCounter () {
          return ps4Data.btn.reportCounter;
        }

        // Reset the internal model of the controller to the default inputs
